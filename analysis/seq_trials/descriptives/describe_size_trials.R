...
sense_check_size_trials <-
  ...
  summarise(n_total = n(),
            ...
            n_event1 = sum(status_primary == "covid_hosp_death" & fu_primary == 1 & !(treatment_strategy_cat_prim != c("Untreated") & tb_postest_treat == 0)),
            n_event2 = sum(status_primary == "covid_hosp_death" & fu_primary == 2 & !(treatment_strategy_cat_prim != c("Untreated") & tb_postest_treat <= 1)),
            n_event3 = sum(status_primary == "covid_hosp_death" & fu_primary == 3 & !(treatment_strategy_cat_prim != c("Untreated") & tb_postest_treat <= 2)),
