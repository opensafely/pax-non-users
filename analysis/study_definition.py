...
study = StudyDefinition(
  ...
  # ever treated with paxlovid without pos test?
  paxlovid_covid_therapeutics_in_study_period=patients.with_covid_therapeutics(
    with_these_therapeutics="Paxlovid",
    with_these_indications="non_hospitalised",
    between=["index_date", end_date],
    find_first_match_in_period=True,
  ...
  paxlovid_without_pos_test=patients.satisfying(
    """
    NOT covid_test_positive
    AND paxlovid_covid_therapeutics_in_study_period
    """,
    return_expectations={
      "incidence": 0.01,
    },
  ...
  in_study_pop=patients.satisfying(
      """
      covid_test_positive
      AND NOT covid_positive_prev_90_days
      AND NOT prev_treated
